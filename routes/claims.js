...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('claims');

// This file contains the logic of every route in Forest Admin for the collection claims:
...
// Create a Claim
router.post('/claims', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Claim
router.put('/claims/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Claim
router.delete('/claims/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/claims', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Claims
router.get('/claims/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Claim
router.get('/claims/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/claims.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Claims
router.delete('/claims', permissionMiddlewareCreator.delete(), (request, response, next) => {
