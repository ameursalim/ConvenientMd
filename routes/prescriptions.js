...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('prescriptions');

// This file contains the logic of every route in Forest Admin for the collection prescriptions:
...
router.post('/prescriptions', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/prescriptions/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/prescriptions/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/prescriptions', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Prescriptions
router.get('/prescriptions/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Prescription
router.get('/prescriptions/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Prescriptions
router.get('/prescriptions.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Prescriptions
router.delete('/prescriptions', permissionMiddlewareCreator.delete(), (request, response, next) => {
