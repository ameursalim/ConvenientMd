...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('policies');

// This file contains the logic of every route in Forest Admin for the collection policies:
...
// Create a Policy
router.post('/policies', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Policy
router.put('/policies/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Policy
router.delete('/policies/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/policies', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Policies
router.get('/policies/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Policy
router.get('/policies/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Policies
router.get('/policies.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
router.delete('/policies', permissionMiddlewareCreator.delete(), (request, response, next) => {
