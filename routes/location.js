...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('location');

// This file contains the logic of every route in Forest Admin for the collection location:
...
// Create a Location
router.post('/location', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Location
router.put('/location/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.get('/location', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Locations
router.get('/location/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Location
router.get('/location/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/location.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
router.delete('/location', permissionMiddlewareCreator.delete(), (request, response, next) => {
