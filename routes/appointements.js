...
const { appointements } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('appointements');

// This file contains the logic of every route in Forest Admin for the collection appointements:
...
router.post('/appointements', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/appointements/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/appointements/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Appointements
router.get('/appointements', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Appointements
router.get('/appointements/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Appointement
router.get('/appointements/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Appointements
router.get('/appointements.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Appointements
router.delete('/appointements', permissionMiddlewareCreator.delete(), (request, response, next) => {
