...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('agents');

// This file contains the logic of every route in Forest Admin for the collection agents:
...
// Create a Agent
router.post('/agents', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Agent
router.put('/agents/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Agent
router.delete('/agents/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/agents', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/agents/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Agent
router.get('/agents/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/agents.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
router.delete('/agents', permissionMiddlewareCreator.delete(), (request, response, next) => {
