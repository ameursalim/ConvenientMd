...
const { untitledTable } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('untitledTable');

// This file contains the logic of every route in Forest Admin for the collection untitledTable:
...
// Create a Untitled Table
router.post('/untitledTable', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Untitled Table
router.put('/untitledTable/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Untitled Table
router.delete('/untitledTable/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Untitled Tables
router.get('/untitledTable', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Untitled Tables
router.get('/untitledTable/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Untitled Table
router.get('/untitledTable/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Untitled Tables
router.get('/untitledTable.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Untitled Tables
router.delete('/untitledTable', permissionMiddlewareCreator.delete(), (request, response, next) => {
